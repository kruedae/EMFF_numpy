...
RR0=[35786000,0.,  0.,1075.,  0.,0.,    35786010,0., 0.,1075., 0.,0.  ,10,1,10,1,10,1]#vector de condiciones iniciales

ts=np.linspace(0,30000,1000000)#mallado temporal

RR=odeint(ec2,RR0,ts,args=(m1,m2))#solucionamos usando el paquete la funcion odeint
